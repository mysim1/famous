...
define(function(require, exports, module) {
  ...
  /**
   * Sets SrcObject of video (Useful for displaying camera feeds)
   *
   * @method setSrcObject
   * @param srcObject {File|Blob} The file or blob to be displayed in the video
   */
  ...
  /**
   * Place the document element this components manages into the document.
  ...
  /**
   * Remove this components and contained content from the document.
   *   Note: This doesn't actually remove the <video> element from the
   *   document.
   * @private
   * @method recall
   *
   * @param {Node} target node to which the components was deployed
   */
